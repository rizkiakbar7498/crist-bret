...
<html lang="en">
<head>
  <title>Cristian &mdash;  Bretton</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

  <link href="https://fonts.googleapis.com/css?family=Rubik:300,400,700|Oswald:400,700" rel="stylesheet">

  <link rel="stylesheet" href="<?php base_url(); ?>asset/fonts/icomoon/style.css">

  <link rel="stylesheet" href="<?php base_url(); ?>asset/css/bootstrap.min.css">
  <link rel="stylesheet" href="<?php base_url(); ?>asset/css/jquery.fancybox.min.css">
  ...
  <link rel="stylesheet" href="<?php base_url(); ?>asset/fonts/flaticon/font/flaticon.css">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <header class="site-navbar js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container">
        <div class="row align-items-center position-relative">
          ...
          <div class="site-logo">
            <a href="http://localhost/crist-bret/" class="text-black"><span class="text-primary">Cristian Bretton</a>
            </div>
      ...
      <div class="owl-carousel slide-one-item">
        ...
        <div class="site-section-cover overlay img-bg-section" style="background-image: url('<?php base_url(); ?>asset/img/1.jpg'); " >
          <div class="container">
            <div class="row align-items-center justify-content-center text-center">
              <div class="col-md-12 col-lg-7">
                <h1 data-aos="fade-up" data-aos-delay=""> Cristian Bretton a new product cosmetic international</h1>  
                ...
                <p data-aos="fade-up" data-aos-delay="200"><a href="#services-section" class="btn btn-outline-white border-w-2 btn-md">Service</a></p>
              </div>
            </div>
          </div>
        ...
        <div class="site-section-cover overlay img-bg-section" style="background-image: url('<?php base_url(); ?>asset/img/2.jpg'); " >
          <div class="container">
            <div class="row align-items-center justify-content-center text-center">
              <div class="col-md-12 col-lg-8">
                <h1 data-aos="fade-up" data-aos-delay="">New Generation of Cosmetic to make your live</h1>      
                ...
                <p data-aos="fade-up" data-aos-delay="200"><a href="#about-section" class="btn btn-outline-white border-w-2 btn-md">About</a></p>
              </div>
            </div>
          </div>
        ...
        <div class="block__73694 mb-2">
          <div class="container">
            <div class="row d-flex no-gutters align-items-stretch">
              ...
              <div class="col-12 col-lg-6 block__73422" style="background-image: url('<?php base_url(); ?>asset/img/3.jpg');" data-aos="fade-right" data-aos-delay="">
              </div>
        ...
        <div class="block__73694">
          <div class="container">
            <div class="row d-flex no-gutters align-items-stretch">
              ...
              <div class="col-12 col-lg-6 block__73422 order-lg-2" style="background-image: url('<?php base_url(); ?>asset/img/5.jpg');" data-aos="fade-left" data-aos-delay="">
              </div>
        ...
        <div class="owl-carousel nonloop-block-13">
          ...
          <div>
            <div class="block-testimony-1 text-center">
              ...
              <figure>
                <img src="<?php base_url(); ?>asset/images/person_2.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
              </figure>
              <h3 class="font-size-20 mb-4 text-whitesmoke">Ken Davis</h3>
          ...
          <div>
            <div class="block-testimony-1 text-center">
              ...
              <figure>
                <img src="<?php base_url(); ?>asset/images/person_1.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
              </figure>
          ...
          <div>
            <div class="block-testimony-1 text-center">
              ...
              <figure>
                <img src="<?php base_url(); ?>asset/images/person_3.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
              </figure>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-6" data-aos="fade-up" data-aos-delay="">
            <div>
              <a href="single.html" class="mb-4 d-block"><img src="<?php base_url(); ?>asset/images/hero_2.jpg" alt="Image" class="img-fluid rounded"></a>
  ...
  <script src="<?php base_url(); ?>asset/js/jquery-3.3.1.min.js"></script>
  ...
  <script src="<?php base_url(); ?>asset/js/jquery.sticky.js"></script>
  ...
  <script src="<?php base_url(); ?>asset/js/jquery.fancybox.min.js"></script>
